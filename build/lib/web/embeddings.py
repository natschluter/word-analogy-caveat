...
def load_embedding(fname, format="word2vec_bin", normalize=True, lower=False, clean_words=False, load_kwargs={}, nonorm=False, nocheat=False):
	"""
	...
	if normalize:
		w.normalize_words(inplace=True, nonorm=nonorm)
